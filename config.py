...
# NOTE: These retailers use JavaScript to load products and require Selenium
# Currently disabled - use --amazon-only flag for working scraper
RETAILER_CONFIGS = {
    # 'ldlc': {
    #     'name': 'LDLC',
    #     'base_url': 'https://www.ldlc.com',
    #     'ddr5_search_path': '/search/ddr5/',
    #     'gpu_search_path': '/search/rtx/',
    #     'selectors': {
